...
public class HoneyDensity : DensityGenerator
{
    [Header("Noise")]
    public int seed;
    ...
    )
    {
        ...
        densityShader.SetFloat("time", Time.time);

        // Height-based density adjustment
        densityShader.SetFloat("boundsSize", boundsSize);
        densityShader.SetFloat("globalDensityMultiplier", globalDensityMultiplier);
